...
This is a sample CLAUDE.md generated by the `generating-code-standards` skill for a Java/Gradle backend service with PII handling, team workflow, and GitHub Actions CI.
