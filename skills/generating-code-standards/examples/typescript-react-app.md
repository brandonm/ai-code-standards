...
This is a sample CLAUDE.md generated by the `generating-code-standards` skill for a TypeScript React web app with no regulated data, team workflow, and GitHub Actions CI.
