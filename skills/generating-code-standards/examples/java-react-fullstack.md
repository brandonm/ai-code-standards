...
This is a sample CLAUDE.md generated by the `generating-code-standards` skill for a full-stack application with a Java/Gradle backend and React frontend, team workflow, PII handling, and Woodpecker CI.
...
> Auto-generated by the `generating-code-standards` skill. Edit freely — your additions will be preserved on regeneration.
